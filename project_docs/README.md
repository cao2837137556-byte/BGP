...
21. `project_docs/CCFA_TARGET_LINE_AND_EXPERIMENT_GUARDRAILS.md`
22. `project_docs/LEARNING_LAYER_POSITIONING.md`
23. 如需更细的正式资产定位，再看 `论文/实验资产索引_v01.md`
