...
- Current Raw Incident Entry State:
  ...
  - Current risk: key v0 is conservative and under-aggregates; R-AGG-3 should audit whether safe coarser grouping is possible before Evidence-grounded Incident consumes this table.
  - Next recommended step is R-AGG-3 aggregation quality audit, with Evidence-grounded Incident design as the next branch after quality is understood.
  ...
  - R-AGG-2 has now built the first prototype table. Next step is R-AGG-3 aggregation quality audit, then Evidence-grounded Incident construction after the Raw Incident aggregation quality is understood.
  ...
  - R-AGG-1 has now turned this into a schema/mapping design, and R-AGG-2 has built the first prototype table. Next candidate step is R-AGG-3 aggregation quality audit, then Evidence-grounded Incident construction.
