...
def choose_augmentation_label(evidence_support_score: float) -> str:
    if evidence_support_score >= AUGMENT_CONFIG["promoted_threshold"]:
        return "promoted_suspicious"
    if evidence_support_score < AUGMENT_CONFIG["demoted_threshold"]:
        return "demoted_suspicious"
